    ...
    <header className="bg-white rounded-[32px] px-8 py-3 flex items-center justify-between shrink-0 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
      ...
      <div className="flex items-center gap-2">
         ...
         <div className="flex flex-col -space-y-1">
            <span className="text-lg font-semibold tracking-tight text-slate-800">robinhood</span>
      ...
      <div className="flex items-center gap-6">
        ...
        <button 
          ...
          className="text-slate-500 hover:text-[#cc2929] transition-colors relative p-1 hover:bg-slate-50 rounded-full"
        >
          <Bell className="w-5 h-5" />
          <span className="absolute top-1 right-1 w-2 h-2 bg-[#cc2929] rounded-full ring-2 ring-white animate-pulse" />
        </button>
